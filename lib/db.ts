...
import {
  ...
  URBNIT_HOMEPAGE_DEFAULTS,
  mapFaqRow,
  type UrbnitHomepageUpdate,
} from "./homepage-urbnit-db";
import { URBNIT_DEFAULT_FAQS } from "./homepage-urbnit";
...
const HOMEPAGE_DEFAULTS: HomepageSetting = {
  ...
  heroTitleEn: URBNIT_HOMEPAGE_DEFAULTS.heroTitleEn ?? null,
  heroSlogan: HOMEPAGE_DEFAULT_HERO_SLOGAN_AR,
  heroSloganEn: URBNIT_HOMEPAGE_DEFAULTS.heroSloganEn ?? null,
  platformName: HOMEPAGE_DEFAULT_PLATFORM_NAME_AR,
  platformNameEn: URBNIT_HOMEPAGE_DEFAULTS.platformNameEn ?? null,
  ...
  pageTitleEn: URBNIT_HOMEPAGE_DEFAULTS.pageTitleEn ?? null,
  heroBgPreset: "navy",
  ...
  footerCopyrightEn: URBNIT_HOMEPAGE_DEFAULTS.footerCopyrightEn ?? null,
...
async function ensureHomepageUrbnitColumns(): Promise<void> {
  return ensureOnce("ensureHomepageUrbnitColumns", async () => {
    const alters = [
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS hero_gallery_images TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS hero_cta_primary_text TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS hero_cta_primary_text_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS hero_cta_primary_href TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS hero_cta_secondary_text TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS hero_cta_secondary_text_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS hero_cta_secondary_href TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS top_banner_images TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_promo_images TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_promo_title TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_promo_title_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_promo_body TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_promo_body_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_promo_cta_text TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_promo_cta_text_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_promo_cta_href TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_promo_image_url TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_promo_title TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_promo_title_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_promo_body TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_promo_body_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_promo_cta_text TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_promo_cta_text_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_promo_cta_href TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS youtube_promo_image_url TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS youtube_promo_title TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS youtube_promo_title_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS youtube_promo_body TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS youtube_promo_body_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS youtube_promo_cta_text TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS youtube_promo_cta_text_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS faq_title TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS faq_title_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS faq_subtitle TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS faq_subtitle_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS footer_mission TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS footer_mission_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS instagram_url TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS pinterest_url TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_page_title TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_page_title_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_page_intro TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS courses_page_intro_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_page_title TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_page_title_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_page_subtitle TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_page_subtitle_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_page_description TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS packs_page_description_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS about_title TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS about_title_en TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS about_body TEXT`,
      sql`ALTER TABLE "HomepageSetting" ADD COLUMN IF NOT EXISTS about_body_en TEXT`,
    ];
...
async function ensureHomepageFaqTable(): Promise<void> {
  return ensureOnce("ensureHomepageFaqTable", async () => {
    try {
      await sql`
      ...
      `;
      await sql`CREATE INDEX IF NOT EXISTS "HomepageFaq_sort_idx" ON "HomepageFaq"(sort_order)`;
      const countRows = await sql`SELECT COUNT(*)::int AS c FROM "HomepageFaq"`;
      const count = Number((countRows[0] as { c?: number })?.c ?? 0);
      if (count === 0) {
        for (const faq of URBNIT_DEFAULT_FAQS) {
          await sql`
            INSERT INTO "HomepageFaq" (id, question, question_en, answer, answer_en, sort_order)
            VALUES (${faq.id}, ${faq.question}, ${faq.questionEn ?? null}, ${faq.answer}, ${faq.answerEn ?? null}, ${faq.sortOrder})
...
async function ensureCourseSoftwareToolsColumn(): Promise<void> {
  return ensureOnce("ensureCourseSoftwareToolsColumn", async () => {
    try {
      await sql`ALTER TABLE "Course" ADD COLUMN IF NOT EXISTS software_tools TEXT`;
    } catch {
      /* DDL غير متاح */
    }
  });
...
async function ensureStoreProductPackColumns(): Promise<void> {
  return ensureOnce("ensureStoreProductPackColumns", async () => {
    try {
      await sql`ALTER TABLE "StoreProduct" ADD COLUMN IF NOT EXISTS category TEXT`;
      await sql`ALTER TABLE "StoreProduct" ADD COLUMN IF NOT EXISTS is_new BOOLEAN NOT NULL DEFAULT false`;
      await sql`ALTER TABLE "StoreProduct" ADD COLUMN IF NOT EXISTS is_free BOOLEAN NOT NULL DEFAULT false`;
      await sql`ALTER TABLE "StoreProduct" ADD COLUMN IF NOT EXISTS badge_text TEXT`;
    } catch {
      /* DDL غير متاح */
    }
  });
  ...
  try {
    ...
    return {
      heroTemplate: (() => {
        ...
        if (s === "classic" || s === "image_slider" || s === "coming_soon" || s === "urbnit") return s;
        return HOMEPAGE_DEFAULTS.heroTemplate ?? "urbnit";
      })(),
      ...
      heroTitleEn:
        row.hero_title_en != null && String(row.hero_title_en).trim() !== ""
          ...
          : (HOMEPAGE_DEFAULTS.heroTitleEn ?? null),
      ...
      heroSloganEn:
        row.hero_slogan_en != null && String(row.hero_slogan_en).trim() !== ""
          ...
          : (HOMEPAGE_DEFAULTS.heroSloganEn ?? null),
      platformName:
      ...
      platformNameEn:
        row.platform_name_en != null && String(row.platform_name_en).trim() !== ""
          ...
          : (HOMEPAGE_DEFAULTS.platformNameEn ?? null),
      headerLogoUrl: (() => {
        const raw =
      ...
      pageTitleEn:
        row.page_title_en != null && String(row.page_title_en).trim() !== ""
          ...
          : (HOMEPAGE_DEFAULTS.pageTitleEn ?? null),
      ...
      footerCopyrightEn:
        row.footer_copyright_en != null && String(row.footer_copyright_en).trim() !== ""
          ...
          : (HOMEPAGE_DEFAULTS.footerCopyrightEn ?? null),
...
async function listHomepageFaqsUncached(): Promise<HomepageFaq[]> {
  try {
    ...
    const faqs = (rows as Record<string, unknown>[]).map(mapFaqRow);
    if (faqs.length === 0) {
      return URBNIT_DEFAULT_FAQS.map((faq) => ({
        ...faq,
        createdAt: "",
        updatedAt: "",
      }));
...
export async function createHomepageFaq(data: {
  ...
  await sql`
    ...
    VALUES (
      ${data.id},
      ${data.question.trim()},
      ${data.question_en?.trim() || null},
      ${data.answer.trim()},
      ${data.answer_en?.trim() || null},
      ${data.sort_order ?? 0}
    )
  `;
...
export async function updateHomepageFaq(
  ...
  if (data.question !== undefined) {
    await sql`UPDATE "HomepageFaq" SET question = ${data.question.trim()}, updated_at = NOW() WHERE id = ${pid}`;
  }
  if (data.question_en !== undefined) {
    await sql`UPDATE "HomepageFaq" SET question_en = ${data.question_en?.trim() || null}, updated_at = NOW() WHERE id = ${pid}`;
  }
  if (data.answer !== undefined) {
    await sql`UPDATE "HomepageFaq" SET answer = ${data.answer.trim()}, updated_at = NOW() WHERE id = ${pid}`;
  }
  if (data.answer_en !== undefined) {
    await sql`UPDATE "HomepageFaq" SET answer_en = ${data.answer_en?.trim() || null}, updated_at = NOW() WHERE id = ${pid}`;
  }
...
export async function updateHomepageSettings(data: {
  ...
  const urbnitCols: Array<[keyof UrbnitHomepageUpdate, string | null | undefined]> = [
    ...
    ["hero_cta_primary_text_en", data.hero_cta_primary_text_en],
    ["hero_cta_primary_href", data.hero_cta_primary_href],
    ["hero_cta_secondary_text", data.hero_cta_secondary_text],
    ["hero_cta_secondary_text_en", data.hero_cta_secondary_text_en],
    ["hero_cta_secondary_href", data.hero_cta_secondary_href],
    ["top_banner_images", data.top_banner_images],
    ["courses_promo_images", data.courses_promo_images],
    ["courses_promo_title", data.courses_promo_title],
    ["courses_promo_title_en", data.courses_promo_title_en],
    ["courses_promo_body", data.courses_promo_body],
    ["courses_promo_body_en", data.courses_promo_body_en],
    ["courses_promo_cta_text", data.courses_promo_cta_text],
    ["courses_promo_cta_text_en", data.courses_promo_cta_text_en],
    ["courses_promo_cta_href", data.courses_promo_cta_href],
    ["packs_promo_image_url", data.packs_promo_image_url],
    ["packs_promo_title", data.packs_promo_title],
    ["packs_promo_title_en", data.packs_promo_title_en],
    ["packs_promo_body", data.packs_promo_body],
    ["packs_promo_body_en", data.packs_promo_body_en],
    ["packs_promo_cta_text", data.packs_promo_cta_text],
    ["packs_promo_cta_text_en", data.packs_promo_cta_text_en],
    ["packs_promo_cta_href", data.packs_promo_cta_href],
    ["youtube_promo_image_url", data.youtube_promo_image_url],
    ["youtube_promo_title", data.youtube_promo_title],
    ["youtube_promo_title_en", data.youtube_promo_title_en],
    ["youtube_promo_body", data.youtube_promo_body],
    ["youtube_promo_body_en", data.youtube_promo_body_en],
    ["youtube_promo_cta_text", data.youtube_promo_cta_text],
    ["youtube_promo_cta_text_en", data.youtube_promo_cta_text_en],
    ["faq_title", data.faq_title],
    ["faq_title_en", data.faq_title_en],
    ["faq_subtitle", data.faq_subtitle],
    ["faq_subtitle_en", data.faq_subtitle_en],
    ["footer_mission", data.footer_mission],
    ["footer_mission_en", data.footer_mission_en],
    ["instagram_url", data.instagram_url],
    ["pinterest_url", data.pinterest_url],
    ["courses_page_title", data.courses_page_title],
    ["courses_page_title_en", data.courses_page_title_en],
    ["courses_page_intro", data.courses_page_intro],
    ["courses_page_intro_en", data.courses_page_intro_en],
    ["packs_page_title", data.packs_page_title],
    ["packs_page_title_en", data.packs_page_title_en],
    ["packs_page_subtitle", data.packs_page_subtitle],
    ["packs_page_subtitle_en", data.packs_page_subtitle_en],
    ["packs_page_description", data.packs_page_description],
    ["packs_page_description_en", data.packs_page_description_en],
...
async function ensureStoreProductsSchema(): Promise<void> {
  ...
  try {
    ...
    await ensureStoreProductPackColumns();
...
function mapStoreProduct(r: Record<string, unknown>): StoreProductRow {
  return {
    ...
    badgeText: r.badge_text ? String(r.badge_text) : null,
    createdAt:
      r.created_at instanceof Date
        ? r.created_at.toISOString()
  ...
  try {
    ...
    const rows = await sql`
      SELECT id, title, description, price, image_url, pdf_url, is_active, sort_order, created_at,
        category, is_new, is_free, badge_text
      FROM "StoreProduct"
...
export async function createStoreProduct(data: {
  ...
  await sql`
    INSERT INTO "StoreProduct" (id, title, description, price, cost_price, image_url, pdf_url, is_active, sort_order, category, is_new, is_free, badge_text)
    VALUES (
      ${id},
      ${data.title.trim()},
...
export async function updateStoreProduct(
  ...
  if (data.category !== undefined) await sql`UPDATE "StoreProduct" SET category = ${data.category?.trim() || null}, updated_at = NOW() WHERE id = ${pid}`;
  if (data.is_new !== undefined) await sql`UPDATE "StoreProduct" SET is_new = ${data.is_new}, updated_at = NOW() WHERE id = ${pid}`;
  if (data.is_free !== undefined) await sql`UPDATE "StoreProduct" SET is_free = ${data.is_free}, updated_at = NOW() WHERE id = ${pid}`;
  if (data.badge_text !== undefined) await sql`UPDATE "StoreProduct" SET badge_text = ${data.badge_text?.trim() || null}, updated_at = NOW() WHERE id = ${pid}`;
}
...
export async function updateCourse(
  ...
  await ensureCourseBilingualColumns();
  await ensureCourseSoftwareToolsColumn();
