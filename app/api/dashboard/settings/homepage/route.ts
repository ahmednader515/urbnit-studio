...
export async function PUT(request: NextRequest) {
  ...
  let body: {
    ...
    heroGalleryImages?: string | null;
    heroCtaPrimaryText?: string | null;
    heroCtaPrimaryTextEn?: string | null;
    heroCtaPrimaryHref?: string | null;
    heroCtaSecondaryText?: string | null;
    heroCtaSecondaryTextEn?: string | null;
    heroCtaSecondaryHref?: string | null;
    topBannerImages?: string | null;
    coursesPromoImages?: string | null;
    coursesPromoTitle?: string | null;
    coursesPromoTitleEn?: string | null;
    coursesPromoBody?: string | null;
    coursesPromoBodyEn?: string | null;
    coursesPromoCtaText?: string | null;
    coursesPromoCtaTextEn?: string | null;
    coursesPromoCtaHref?: string | null;
    packsPromoImageUrl?: string | null;
    packsPromoTitle?: string | null;
    packsPromoTitleEn?: string | null;
    packsPromoBody?: string | null;
    packsPromoBodyEn?: string | null;
    packsPromoCtaText?: string | null;
    packsPromoCtaTextEn?: string | null;
    packsPromoCtaHref?: string | null;
    youtubePromoImageUrl?: string | null;
    youtubePromoTitle?: string | null;
    youtubePromoTitleEn?: string | null;
    youtubePromoBody?: string | null;
    youtubePromoBodyEn?: string | null;
    youtubePromoCtaText?: string | null;
    youtubePromoCtaTextEn?: string | null;
    faqTitle?: string | null;
    faqTitleEn?: string | null;
    faqSubtitle?: string | null;
    faqSubtitleEn?: string | null;
    footerMission?: string | null;
    footerMissionEn?: string | null;
    instagramUrl?: string | null;
    pinterestUrl?: string | null;
    coursesPageTitle?: string | null;
    coursesPageTitleEn?: string | null;
    coursesPageIntro?: string | null;
    coursesPageIntroEn?: string | null;
    packsPageTitle?: string | null;
    packsPageTitleEn?: string | null;
    packsPageSubtitle?: string | null;
    packsPageSubtitleEn?: string | null;
    packsPageDescription?: string | null;
    packsPageDescriptionEn?: string | null;
  ...
  if (body.heroTemplate !== undefined) {
    ...
    if (!val) {
      hero_template = null;
    } else if (val === "classic" || val === "image_slider" || val === "coming_soon" || val === "urbnit") {
      hero_template = val;
    } else {
      ...
      platform_news_section_title_en:
        body.platformNewsSectionTitleEn !== undefined
          ? (body.platformNewsSectionTitleEn && String(body.platformNewsSectionTitleEn).trim()
              ...
              : null)
          : undefined,
      hero_gallery_images: body.heroGalleryImages,
      hero_cta_primary_text: body.heroCtaPrimaryText,
      hero_cta_primary_text_en: body.heroCtaPrimaryTextEn,
      hero_cta_primary_href: body.heroCtaPrimaryHref,
      hero_cta_secondary_text: body.heroCtaSecondaryText,
      hero_cta_secondary_text_en: body.heroCtaSecondaryTextEn,
      hero_cta_secondary_href: body.heroCtaSecondaryHref,
      top_banner_images: body.topBannerImages,
      courses_promo_images: body.coursesPromoImages,
      courses_promo_title: body.coursesPromoTitle,
      courses_promo_title_en: body.coursesPromoTitleEn,
      courses_promo_body: body.coursesPromoBody,
      courses_promo_body_en: body.coursesPromoBodyEn,
      courses_promo_cta_text: body.coursesPromoCtaText,
      courses_promo_cta_text_en: body.coursesPromoCtaTextEn,
      courses_promo_cta_href: body.coursesPromoCtaHref,
      packs_promo_image_url: body.packsPromoImageUrl,
      packs_promo_title: body.packsPromoTitle,
      packs_promo_title_en: body.packsPromoTitleEn,
      packs_promo_body: body.packsPromoBody,
      packs_promo_body_en: body.packsPromoBodyEn,
      packs_promo_cta_text: body.packsPromoCtaText,
      packs_promo_cta_text_en: body.packsPromoCtaTextEn,
      packs_promo_cta_href: body.packsPromoCtaHref,
      youtube_promo_image_url: body.youtubePromoImageUrl,
      youtube_promo_title: body.youtubePromoTitle,
      youtube_promo_title_en: body.youtubePromoTitleEn,
      youtube_promo_body: body.youtubePromoBody,
      youtube_promo_body_en: body.youtubePromoBodyEn,
      youtube_promo_cta_text: body.youtubePromoCtaText,
      youtube_promo_cta_text_en: body.youtubePromoCtaTextEn,
      faq_title: body.faqTitle,
      faq_title_en: body.faqTitleEn,
      faq_subtitle: body.faqSubtitle,
      faq_subtitle_en: body.faqSubtitleEn,
      footer_mission: body.footerMission,
      footer_mission_en: body.footerMissionEn,
      instagram_url: body.instagramUrl,
      pinterest_url: body.pinterestUrl,
      courses_page_title: body.coursesPageTitle,
      courses_page_title_en: body.coursesPageTitleEn,
      courses_page_intro: body.coursesPageIntro,
      courses_page_intro_en: body.coursesPageIntroEn,
      packs_page_title: body.packsPageTitle,
      packs_page_title_en: body.packsPageTitleEn,
      packs_page_subtitle: body.packsPageSubtitle,
      packs_page_subtitle_en: body.packsPageSubtitleEn,
      packs_page_description: body.packsPageDescription,
      packs_page_description_en: body.packsPageDescriptionEn,
      about_title: body.aboutTitle,
      about_title_en: body.aboutTitleEn,
      about_body: body.aboutBody,
      about_body_en: body.aboutBodyEn,
    });
